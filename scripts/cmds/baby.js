...
module.exports.onChat = async ({
    ...
    try {
        ...
        if (body.startsWith("baby") || body.startsWith("bby") || body.startsWith("bot") || body.startsWith("jan") || body.startsWith("babu") || body.startsWith("janu")) {
            ...
            const rawReplies = [
                "Can I help you 😒🌷",
                "আমাকে না ডেকে আমার Boss Tusher কে ডাক 🐿️💨",
                "আমি তুমার বোউ এর সাথে ব্যস্ত আছি 🙈👀🌊",
                "Hea Jan Bolo 🎀",
                "এখন আমার মন ভালো না পরে কথা বলি 💗☺️",
                "তুমি নাকি আমার Boss Tusher এর বউ 🙈😥",
                "জাও তুমি আমাই ভালোবাসোনা 😒😒🫶",
                "আমারে এতো ডাকিস না আমাকে এতো ডাজলে গুয়ার ভিতর বাশ ভোরে দেবো কিন্তু __😜😜🫶"
];
